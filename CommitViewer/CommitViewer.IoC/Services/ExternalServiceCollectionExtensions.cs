...
{
    public class ExternalServiceCollectionExtensions
    {
        public static void InitializeExternalApplicationServices(IServiceCollection services, IConfiguration configuration)
        {
